  ...
  return (
    <main>
      ...
      <section className="bg-mvf-blue px-6 py-16 text-center text-white">
        <blockquote className="mx-auto max-w-[900px] text-2xl font-bold italic leading-10 md:text-3xl">
          &apos;Your support started a chain reaction of events that has led me to not only achieving my professional goals but also
          my personal happiness&apos;
        </blockquote>
        <p className="mt-4 text-sm font-bold">Liam Castellas, 2008 alumni, cricket coach</p>
      </section>
