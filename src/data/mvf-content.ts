import type { AlumniQuote, ImageAsset, InfoSection, NavItem, NewsPost, WinnerEntry, WinnerYear } from "@/types/mvf";
...
export const alumniQuotes: AlumniQuote[] = [
  {
    name: "Liam Castellas",
    award: "2008 awardee",
    descriptor: "Cricket coach",
    quote:
      "Your support started a chain reaction of events that has led me to not only achieving my professional goals but also my personal happiness.",
    impact: "A reminder that one grant can keep opening doors well beyond the award year.",
  },
  {
    name: "Anne Kershaw",
    award: "1988 awardee",
    descriptor: "Historian and arts leader",
    quote: "Having work experience in London really opened up my career in Australia.",
    impact:
      "The grant supported an internship at the Museum of London and helped launch a long career across museums, arts planning, and arts management.",
  },
  {
    name: "Alison O'Connor",
    award: "1990 awardee",
    descriptor: "Town planner",
    quote:
      "The scholarship helped me stand out from the crowd at the start of my career, and the experiences the European Tour gave me certainly shaped my personal and professional values.",
    impact:
      "Alison credits the award with broadening her perspective on the built environment and strengthening her early career path.",
  },
  {
    name: "Samantha Brown Cowan",
    award: "1992 awardee",
    descriptor: "Ballroom dancer",
    quote: "The connection to community and sense of purpose was worth more than the monetary value awarded.",
    impact:
      "The scholarship helped Samantha continue lessons and competition during a financially difficult period as a student.",
  },
];
